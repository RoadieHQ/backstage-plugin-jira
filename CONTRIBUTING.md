# Contributing to the Backstage Jira plugin

We want the Backstage Jira plugin to become the best possible Jira plugin for Backstage. This is an ambitious goal, and we can't do it without the support of the community.
...
The Backstage Jira plugin is released under the Apache 2.0 License, and original creations contributed to this repo are accepted under the same license.
...
No one likes bugs. Report bugs as an issue [here](https://github.com/RoadieHQ/backstage-plugin-jira/issues/new?assignees=&labels=bug&template=bug_template.md).
...
The best way to send feedback is to file [an issue](https://github.com/RoadieHQ/backstage-plugin-jira/issues/new).
...
Have you started using the Backstage Jira plugin. Adding your company to [ADOPTERS](https://github.com/RoadieHQ/backstage-plugin-jira/blob/main/ADOPTERS.md) really helps the project.
...
See [SECURITY.md](https://github.com/RoadieHQ/backstage-plugin-jira/blob/main/SECURITY.md)
